...
//========================================
    ...
    wordDictionary : { 
        ...
        "aiming line": "the imaginary line through the cue ball in the direction of the intended target (e.g., the center of the ghost ball) that results in contact with a rail or the object ball at the desired contact point.",
        ...
        "double draw shot": "a good-action draw shot where the cue ball draws back to a nearby cushion and retains enough backspin after rebound to draw back toward the cushion again.",
        "double the pocket": "intentionally rebound the cue ball off both pocket points for position or to avoid a bank double kiss.",
        "double the rail": "use reverse english at a shallow angle to a rail to cause the cue ball to return to the same rail after hitting the adjacent rail.",
        "egg": "slang for cue ball.",
        ...
        "fast cloth": "cloth with very low rolling resistance (i.e., the cue ball travels far before slowing).",
        ...
        "hit": "the action of one ball contacting another (usually the cue ball into an OB).",
